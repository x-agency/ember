...
<section id="ember-experience">
    <div class="container">
        ...
        <div class="row intro-grid">
            ...
            <div class="col-md-4 intro-grid-item">
                <div class="grid-img"><img src="/wp-content/themes/ember/img/intro-img-3.jpg" alt=""></div>
                <div class="grid-title"><span>Tailored</span> Lifestyle Plan.</div>
                <div class="grid-number">
        ...
        <div class="row meet-wrapper">
            <div class="meet-inner">
                ...
                <!-- <p>Dr. Brian Blank, board certified in family medicine, is the founder of Ember Modern Medicine. Having
                    ...
                    and freelance reporter at CNN before producing at the Fox Business Network. He likes to joke that
            ...
            <div class="member-block order-2 order-md-1">
                ...
                <div class="services-list">
                    <ul class="list-unstyled">
                        ...
                        <li>In-office labwork free</li>
                        <li>Prescription program</li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="mb-1">At <span style="color: #133738">Ember</span>, we treat people <span>well</span>.</h1>
                <h3>And our membership pricing is no different.</h3>
            </div>
        </div>
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="table container">
                            <div class="row header">
                                <div class="col-5">
                                    <h4>Office Visit Charges</h4>
                                </div>
                                <div class="col-3">
                                    <h4>Included at Ember</h4>
                                </div>
                                <div class="col-4">
                                    <h4>Local Insurance Price</h4>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-5">
