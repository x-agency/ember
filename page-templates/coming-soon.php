...
<section id="page-header" class="coming-soon">
    ...
    <div class="flame">
        ...
        <p class="special">Better <span><strong>Care</strong></span>. Better <span><strong>Health</strong></span>. Better <span><strong>You</strong></span>.</p>
        <p class="opening">Opening <span>Spring 2021</span> | Greenville, SC</p>
    </div>
    <div class="main">
        <p>
            <strong>
        ...
        <p>We provide a more comprehensive pathway to personal well-being,<br>
            &nbsp;combining <span>lifestyle</span>, <span>nutrition</span>, <span>health training</span>, and <span>direct access</span> to your<br> 
